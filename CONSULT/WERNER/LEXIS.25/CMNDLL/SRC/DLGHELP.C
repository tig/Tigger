...
/*************************************************************************
 *  void FAR PASCAL DlgSetItemLength( HWND hDlg, WORD wID, WORD wLength ) ;
 *
 *  Description: 
 *
...
/*************************************************************************
 *  WORD FAR PASCAL LBGetCurSel( HWND hLB )
 *
 *  Description:
...
/*************************************************************************
 *  BOOL FAR PASCAL LBGetText( HWND hLB, WORD wItem, LPSTR lpszText, WORD wMax )
 *
 *  Description:
...
/*************************************************************************
 *  BOOL FAR PASCAL LBAddString( HWND hLB, LPSTR lpszText )
 *
 *  Description:
...
/*************************************************************************
 *  WORD FAR PASCAL LBFindString( HWND hLB, WORD wStart, LPSTR lpszPrefix )
 *
 *  Description:
...
/*************************************************************************
 *  WORD FAR PASCAL LBSelectString( HWND hLB, WORD wStart, LPSTR lpszPrefix )
 *
 *  Description:
