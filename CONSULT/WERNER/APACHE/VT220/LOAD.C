                                      ...
                                      LPSTR lpFile )
{
   ...
   {
      LoadString( hInstLib, IDS_DEFAULT_TRANSLATE, szDefault, MAXLEN_TEMPSTR ) ;
      DECGL( npECB ) =
   ...
   {
      LoadString( hInstLib, IDS_DEFAULT_USENUMLOCK, szDefault, MAXLEN_TEMPSTR ) ;
      USENUMLOCK( npECB ) =
         GetPrivateProfileTrueFalse( lpSection, szKey, szDefault, lpFile ) ;
   }
//   if (LoadString( hInstLib, IDS_SETTINGS_SENDDEL, szKey, MAXLEN_TEMPSTR ))
//   {
//      LoadString( hInstLib, IDS_DEFAULT_SENDDEL, szDefault, MAXLEN_TEMPSTR ) ;
//      SENDDEL( npECB ) =
//         GetPrivateProfileTrueFalse( lpSection, szKey, szDefault, lpFile ) ;
//   }
   ...
   GetFonts( lpSection, &NORMALFONT( npECB ),
