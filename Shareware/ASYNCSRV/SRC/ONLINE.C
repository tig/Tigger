      ...
      case WM_TIMER:
      {
         switch( wParam )
         {
            case IDTIMER_ONLINE_FSM:
               ...
               * all of ASYNCSRV.  This sucker drives the OnlineFSM
 ...
 *    stoping this FSM.
 *
 *    This function is the core of ASYNCSRV's interaction with
...
//                     Zmodem( hwnd, ZM_SHOWSTATUS, 0L, 0L ) ;
 ...
 //                     ShowOnlineDownloadStuff( hwnd, TRUE ) ;
            ...
            case STATE_ONLINE_RESYNC:
                ...
                * state.  Its purpose is to resynchronize ASYNCSRV
