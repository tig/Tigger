...
//Function prototypes.
LRESULT CALLBACK fnMusTest(HWND, UINT, WPARAM, LPARAM);
...
HWND WINAPI CreateMuScrollTest( HWND hwndParent )
{
    WNDCLASS    wc;
    HWND        hWnd;
    MSG         msg;
    ...
    hVertMS=CreateWindow("microscroll", "1,99,50",
                 ...
                 hWnd, ID_VERTSCROLL, hinstApp, 0L);
    ...
    hHorzMS=CreateWindow("microscroll", "1,99,50",
                 ...
                 hWnd, ID_HORZSCROLL, hinstApp, 0L);
...
LRESULT CALLBACK fnMusTest(HWND hWnd, UINT iMessage,WPARAM wParam, LPARAM lParam)
    {
    LONG        lPos;
    short       wPos;
    char        szNum[5];
