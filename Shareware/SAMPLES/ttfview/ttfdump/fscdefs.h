/*
        ...
        Change History (most recent first):
          ...
          <ù1.1>  5/26/89        CEL             Integrated the new Font Scaler 1.0 into Spline Fonts
...
#define SWAPL(a)                (unsigned long) ((((unsigned long) a & 0xffL) << 24) | (((unsigned long) a & 0xff00L) << 8) | (((unsigned long) a & 0xff0000L) >> 8) | ((unsigned long) a >> 24))
