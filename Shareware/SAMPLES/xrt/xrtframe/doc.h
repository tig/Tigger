...
// Operations
    ...
    void UpdateDataItems( CRequest* pRequest, PSIMSTOCK pStock ) ;
    void ClearDataItems() ;
...
public:
    ...
    afx_msg LPDISPATCH Requests(const VARIANT FAR& item);
    afx_msg LPDISPATCH DataItems(const VARIANT FAR& item);
    afx_msg void Copy();
    //}}AFX_DISPATCH
