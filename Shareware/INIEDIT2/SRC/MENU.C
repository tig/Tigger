      ...
      case WM_MENUSELECT:
         ...
         {   
            ...
            if ((LOWORD(lParam) & MF_POPUP))
            {
               ...
               if (GetSubMenu( hMenu, IDM_EDIT_COPY ) == (HMENU)wParam)
               {
                  SetWindowText( hwndStat, rglpsz[IDS_MNU_EDIT_COPY] ) ;
                  break ;
               }

               if (GetSubMenu( hMenu, IDM_EDIT_ADD ) == (HMENU)wParam)
               {
                  SetWindowText( hwndStat, rglpsz[IDS_MNU_EDIT_ADD] ) ;
                  break ;
               }

               if (GetSubMenu( hMenu, IDM_EDIT_DEL ) == (HMENU)wParam)
               {
                  SetWindowText( hwndStat, rglpsz[IDS_MNU_EDIT_DEL] ) ;
                  break ;
               }
               ...
               if (GetSubMenu( hMenu, 5 ) == (HMENU)wParam)
               {
                  SetWindowText( hwndStat, rglpsz[IDS_MNU_HELP] ) ;
                  break ;
               }
