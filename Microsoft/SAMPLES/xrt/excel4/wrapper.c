...
HDDEDATA EXPENTRY __export fnWrapperCallback(WORD wType, WORD wFmt, HCONV hConv, HSZ hsz1,
...
{
    #ifdef _DEBUG
    OutputDebugString( "Calling DdeUninitialize...\r\n" ) ;
    #endif
...
HDDEDATA EXPENTRY __export fnWrapperCallback( WORD wType, WORD wFmt, HCONV hConv, HSZ hsz1, HSZ hsz2,
...
{   
    ...
    #ifdef _DEBUG
        case XTYP_ADVSTART:
            OutputDebugString( "XTYP_ADVSTART\r\n" ) ;
            goto doit ;            
        break ;
        case XTYP_CONNECT:
            OutputDebugString( "XTYP_CONNECT\r\n" ) ;
            goto doit ;            
        break ;
        case XTYP_EXECUTE:
            OutputDebugString( "XTYP_EXECUTE\r\n" ) ;
            goto doit ;            
        break ;
        case XTYP_REQUEST:
            OutputDebugString( "XTYP_REQUEST\r\n" ) ;
            goto doit ;            
        break ;
        case XTYP_ADVREQ:
            OutputDebugString( "XTYP_ADVREQ\r\n" ) ;
            goto doit ;            
        break ;
        case XTYP_ADVDATA:
            OutputDebugString( "XTYP_ADVDATA\r\n" ) ;
            goto doit ;            
        break ;
        
        case XTYP_POKE:
            OutputDebugString( "XTYP_POKE\r\n" ) ;
doit:        
    #else
        case XTYP_ADVSTART:
        case XTYP_CONNECT:
