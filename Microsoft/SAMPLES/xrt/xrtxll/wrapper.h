...
typedef BOOL        (WINAPI *CBFNIN)(HDDEDATA);
typedef HDDEDATA    (WINAPI *CBFNOUT)(HDDEDATA);
...
UINT WINAPI InitializeDDE( LPDWORD pidInst, LPDDESERVICETBL AppSvcInfo,  DWORD dwFilterFlags, HANDLE hInst);
