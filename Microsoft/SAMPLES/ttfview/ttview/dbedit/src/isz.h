...
#define IDS_INI_OPTIONS                      (FIRST_IDS + 4)
#define IDS_INI_OPTIONS_SPEC                 (FIRST_IDS + 5)
#define IDS_DEFAULTOPT                       (FIRST_IDS + 6)
#define IDS_INI_POS                          (FIRST_IDS + 7)
#define IDS_INI_POS_SPEC                     (FIRST_IDS + 8)
#define IDS_DEFAULTFONT                      (FIRST_IDS + 9)
#define IDS_INI_FONT                         (FIRST_IDS + 10)
#define IDS_INI_FONT_SPEC                    (FIRST_IDS + 11)
#define IDS_INI_WSHOW                        (FIRST_IDS + 12)

#define IDS_MNU_FILE                        (FIRST_IDS + 13)
#define IDS_MNU_FILE_NEW                    (FIRST_IDS + 14) 
#define IDS_MNU_FILE_OPEN                   (FIRST_IDS + 15) 
#define IDS_MNU_FILE_SAVE                   (FIRST_IDS + 16)
#define IDS_MNU_FILE_SAVEAS                 (FIRST_IDS + 17)    
#define IDS_MNU_FILE_EXIT                   (FIRST_IDS + 18) 
#define IDS_MNU_OPT                         (FIRST_IDS + 19) 
#define IDS_MNU_OPT_FONT                    (FIRST_IDS + 20) 
#define IDS_MNU_OPT_PREFERENCES             (FIRST_IDS + 21) 
#define IDS_MNU_OPT_STAT                    (FIRST_IDS + 22)
#define IDS_MNU_HELP                        (FIRST_IDS + 23) 
#define IDS_MNU_HELP_CONTENTS               (FIRST_IDS + 24) 
#define IDS_MNU_HELP_SEARCH                 (FIRST_IDS + 25) 
#define IDS_MNU_HELP_ONHELP                 (FIRST_IDS + 26) 
#define IDS_MNU_HELP_ABOUT                  (FIRST_IDS + 27)
#define IDS_SMNU                            (FIRST_IDS + 28)
#define IDS_SMNU_SIZE                       (FIRST_IDS + 29)
#define IDS_SMNU_MOVE                       (FIRST_IDS + 30)
#define IDS_SMNU_MINIMIZE                   (FIRST_IDS + 31)
#define IDS_SMNU_MAXIMIZE                   (FIRST_IDS + 32)
#define IDS_SMNU_CLOSE                      (FIRST_IDS + 33)
#define IDS_SMNU_RESTORE                    (FIRST_IDS + 34)
#define IDS_SMNU_TASKLIST                   (FIRST_IDS + 35)
#define IDS_HELPFILE                        (FIRST_IDS + 36)
#define IDS_HEXWORD                         (FIRST_IDS + 37)
#define IDS_HEXDWORD                        (FIRST_IDS + 38)
#define IDS_APPTITLE                        (FIRST_IDS + 39)
#define IDS_STAT_READY                      (FIRST_IDS + 40)
#define IDS_BOLD                            (FIRST_IDS + 41)
#define IDS_ITALIC                          (FIRST_IDS + 42)
#define IDS_BOLDITALIC                      (FIRST_IDS + 43)
#define IDS_REGULAR                         (FIRST_IDS + 44) 
#define IDS_SAMPLE_ALPHA                    (FIRST_IDS + 45)
#define IDS_SAMPLE_DIGIT                    (FIRST_IDS + 46)
#define IDS_SAMPLE_PANOSE                   (FIRST_IDS + 47)
#define IDS_DEF_SPEC                        (FIRST_IDS + 48)

#define LAST_IDS (FIRST_IDS + 48)
