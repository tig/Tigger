// Pager.cpp : Implementation of DLL Exports.
...
//
//		Modify the custom build rule for Pager.idl by adding the following 
...
//		run nmake -f Pagerps.mak in the project directory.
