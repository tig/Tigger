...
CGenericDataObject::CGenericDataObject(IUnknown* punkOuter /*=NULL*/, IDataObject* pdoSource /*=NULL*/)
{
		...
		for (UINT nIndex = 0; nIndex < pThis->m_nSize; nIndex++)
		{
            ...
            case TYMED_FILE:    // stm contains filename
                ...
                else
                {
                    ...
                    ASSERT(pb);
                    pstmData->Write(pb, GlobalSize(pThis->m_pDataCache[nIndex].m_stgMedium.hGlobal), NULL);
