...
IMPLEMENT_OLECREATE(CDispatchViewer, "Ole2View Automation Interface Viewers", 0xd2af7a60, 0x4c42, 0x11ce, 0xb2, 0x7d, 0x00, 0xaa, 0x00, 0x1f, 0x73, 0xc1) ;
...
void CDispatchDlg::OnViewTypeInfo() 
{
    ...
    if (m_uiTypeInfoCount > 0)
    {
        ITypeInfo* pti = NULL ;
        HRESULT hr = m_pdisp->GetTypeInfo(0, GetUserDefaultLCID(), &pti) ;
        if (SUCCEEDED(hr) && pti)
        {
